...
attrib -r "..\utp\contract\*.h" >>logfile.txt
 ...
 set dcf=Ap_SrlComInput


set SWC=Ap_SrlComInput


..\..\..\Tools\AsrProject\Generators\Rte\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g i -o "..\src" >>logfile.txt
..\..\..\Tools\AsrProject\Generators\Rte\dvrtegen -d "..\autosar\%dcf%.dcf" -m %SWC% -g c -o "..\utp\contract\Ap_SrlComInput" >>logfile.txt