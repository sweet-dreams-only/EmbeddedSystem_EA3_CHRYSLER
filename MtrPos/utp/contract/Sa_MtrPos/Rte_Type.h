...
struct Rte_CDS_Sa_MtrPos
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_AlignedCumMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_AssistAssemblyPolarity_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_CumMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_CumMtrPosMRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_SysCCumMtrPosCRF_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS_APPL_VAR) MtrPos_Per2_SysCCumMtrPosMRF_Deg_f32;
  /* PIM Handles section */
  P2VAR(MtrPosCal_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_MtrPosSnsr_EOLData;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_MtrPos, RTE_CONST, RTE_CONST) Rte_Inst_Sa_MtrPos;
...
#    error "The magic number of the generated file <C:/ccm_wa/EPS/570/I410/MtrPos/utp/contract/Sa_MtrPos/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
