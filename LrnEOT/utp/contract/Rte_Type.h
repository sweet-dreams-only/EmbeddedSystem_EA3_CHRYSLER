...
struct Rte_CDS_Ap_LrnEOT
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_LRNEOT_APPL_VAR) LrnEOT_Per1_PostLimitTorque_MtrNm_f32;
  /* PIM Handles section */
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/LrnEOT-nzt9hv/LrnEOT/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
