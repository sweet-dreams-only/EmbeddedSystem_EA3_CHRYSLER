...
#    error "The magic number of the generated file <C:/Synergy_projects/HwPwUp-lz4p8n/HwPwUp/utp/contract/Ap_HwPwUp/Rte_Ap_HwPwUp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
