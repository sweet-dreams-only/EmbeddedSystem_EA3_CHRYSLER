 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_HwPwUp.c
 *     Workspace:  C:/Synergy_projects/HwPwUp-lz4p8n/HwPwUp/autosar
 *     SW-C Type:  Ap_HwPwUp
 *  Generated at:  Thu Mar 14 13:19:08 2013
 *
...
STATIC VAR(PowerUpSequenceType, AP_HWPWUP_VAR) PowerUpState_Cnt_M_enum;
STATIC VAR(boolean, AP_HWPWUP_VAR) PwrDiscATestStart_Cnt_M_lgc;
STATIC VAR(boolean, AP_HWPWUP_VAR) TMFTestStart_Cnt_M_lgc;
STATIC VAR(boolean, AP_HWPWUP_VAR) PwrDiscBTestStart_Cnt_M_lgc;
STATIC VAR(boolean, AP_HWPWUP_VAR) MtrDrvrInitStart_Cnt_M_lgc;
 ...
 *********************************************************************************************************************/
	...
	switch(PowerUpState_Cnt_M_enum)
	{
		case PWRUP_PWRDISCSTEPA:
			...
			{
				PwrDiscATestStart_Cnt_M_lgc = TRUE;
			}
			break;
		...
		case PWRUP_PWRDISCSTEPB:
			...
			{
				PwrDiscBTestStart_Cnt_M_lgc = TRUE;
			}
			break;
		...
		case PWRUP_MTRDRIVERINIT:
			...
			{
				MtrDrvrInitStart_Cnt_M_lgc = TRUE;
			}
			break;
 ...
 *********************************************************************************************************************/
	...
	PowerUpState_Cnt_M_enum = PWRUP_PWRDISCSTEPA;
	
	MtrDrvrInitStart_Cnt_M_lgc = FALSE;
	Rte_IWrite_HwPwUp_Trns1_MtrDrvrInitStart_Cnt_lgc(FALSE);
	PwrDiscATestStart_Cnt_M_lgc = FALSE;
	Rte_IWrite_HwPwUp_Trns1_PwrDiscATestStart_Cnt_lgc(FALSE);
	PwrDiscBTestStart_Cnt_M_lgc = FALSE;
	Rte_IWrite_HwPwUp_Trns1_PwrDiscBTestStart_Cnt_lgc(FALSE);
	TMFTestStart_Cnt_M_lgc = FALSE;
 ...
 *********************************************************************************************************************/
	...
	PowerUpState_Cnt_M_enum = PWRUP_DISABLE;
