...
sint16 BilinearXYM_s16_u16Xs16YM_Cnt(uint16 BS, uint16 input, const uint16* BSTbl, uint16 BSsize, const uint16* XTbl, const sint16* YMTbl, uint16 Xsize)
{
	...
	Numerator_f32 = (float32)((sint32)YMTbl[ArrayIndex2] - (sint32)YMTbl[ArrayIndex1]) *
	                ((float32)((sint32)BSTbl[BSindex+1] - (sint32)BSTbl[BSindex]) * (float32)XInputDiff) + 
	                (float32)((sint32)YMTbl[ArrayIndex3] - (sint32)YMTbl[ArrayIndex1]) *
	                ((float32)BSInputDiff * (float32)((sint32)XTbl[Xindex+1] - (sint32)XTbl[Xindex])) +
	...
	Denominator_f32 = (float32)((sint32)BSTbl[BSindex+1] - (sint32)BSTbl[BSindex]) * ((sint32)XTbl[Xindex+1] - (sint32)XTbl[Xindex]);
...
uint16 BilinearXMYM_u16_u16XMu16YM_Cnt(uint16 BS, uint16 input, const uint16* BSTbl, uint16 BSsize, const uint16* XMTbl, const uint16* YMTbl, uint16 Xsize)
{
    ...
    Den3_s32 = ((sint32)BSTbl[BSindex+1] - (sint32)BSTbl[BSindex]);
	
	Numerator_f32 = (float32)Mult1_s32 * 
	             	(float32)((sint32)BSTbl[BSindex+1] -(sint32)BS) * 
...
/*******************************************************************************
  * Name		:	IntplVarXY_u16_u16Xu16Y_Cnt (TableX, TableY,
  *					 Size, input) 
...
uint16 IntplVarXY_u16_u16Xu16Y_Cnt (const uint16 *TableX, const uint16 *TableY, 
						uint16 Size, uint16 input)
{
uint16	output;
uint16 	index = 0;
sint16 	diffY, diffX, diffXinput, tmpout2,sOutput;
sint32 	tmpout1;
...
/*******************************************************************************
  * Name		:	IntplVarXY_u16_s16Xu16Y_Cnt (TableX, TableY,
  *					 Size, input) 
...
uint16 IntplVarXY_u16_s16Xu16Y_Cnt (const sint16 *TableX, const uint16 *TableY, 
						uint16 Size, sint16 input)
{
uint16	output;
uint16 	index = 0;
sint16 	diffY, diffX, diffXinput, tmpout2, sOutput;
...
/*******************************************************************************
  * Name		:	IntplVarXY_s16_s16Xs16Y_Cnt (TableX, TableY,
  *					 Size, input) 
...
sint16 IntplVarXY_s16_s16Xs16Y_Cnt (const sint16 *TableX, const sint16 *TableY, 
						uint16 Size, sint16 input)
{
sint16	output;
uint16 	index = 0;
...
/*******************************************************************************
  * Name		:	IntplVarXY_s16_u16Xs16Y_Cnt (TableX, TableY,
  *					 Size, input) 
...
sint16 IntplVarXY_s16_u16Xs16Y_Cnt (const uint16 *TableX, const sint16 *TableY, 
						uint16 Size, uint16 input)
{
sint16	output;
uint16 	index = 0;
...
/*******************************************************************************
  * Name		:	IntplFxdX_u16_u16Xu16Y_Cnt (DeltaX, TableY,
  *					 Size, input) 
...
uint16 IntplFxdX_u16_u16Xu16Y_Cnt (uint16 DeltaX, const uint16 *TableY, 
						uint16 Size, uint16 input)
{

uint16	output;
uint16 	index = 0;
sint16 	diffY, diffXinput, tmpout2, sOutput, sDeltaX;
sint32 	tmpout1; 
...
tmpout1 = (sint32)diffY * (sint32)diffXinput;
sDeltaX = FPM_Fix_m(DeltaX, u16p0_T, s15p0_T);
/* Here, the lower 16 bits are assigned to tmpout2 */
tmpout2 = tmpout1 / (sint32)sDeltaX;
...
/*******************************************************************************
  * Name		:	IntplFxdX_u16_s16Xu16Y_Cnt (DeltaX, TableY,
  *					 Size, input) 
...
uint16 IntplFxdX_u16_s16Xu16Y_Cnt (sint16 DeltaX, const uint16 *TableY, 
						uint16 Size, sint16 input)
{
uint16	output;
uint16 	index = 0;
sint16 	diffY, diffXinput, tmpout2, sOutput;
sint32 	tmpout1; 
...
/*******************************************************************************
  * Name		:	IntplFxdX_s16_s16Xs16Y_Cnt (DeltaX, TableY,
  *					 Size, input) 
...
sint16 IntplFxdX_s16_s16Xs16Y_Cnt (sint16 DeltaX, const sint16 *TableY, 
						uint16 Size, sint16 input)
{
sint16	output;
uint16 	index = 0;
...
/*******************************************************************************
  * Name		:	IntplFxdX_s16_u16Xs16Y_Cnt (DeltaX, TableY,
  *					 Size, input) 
...
sint16 IntplFxdX_s16_u16Xs16Y_Cnt (uint16 DeltaX, const sint16 *TableY, 
						uint16 Size, uint16 input)
{
sint16	output;
uint16 	index = 0;
sint16 	diffY, diffXinput, tmpout2, sDeltaX;
sint32 	tmpout1; 
