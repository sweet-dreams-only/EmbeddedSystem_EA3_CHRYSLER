...
* %version:          12 % 
* %derived_by:       zz4r1x %
* %date_modified:    Tue Mar 19 09:49:56 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
STATIC	VAR(uint8, AUTOMATIC) Metrics_ActiveTask_Cnt_M_u08;
STATIC	VAR(uint8, AUTOMATIC) Metrics_ActiveRunnable_Cnt_M_u08;
...
FUNC(void, METRICS_CODE) Metrics_TaskEnd( uint16 Id )
{
	...
	if(0 == startTime_Cnt_T_u32 || Id != Metrics_ActiveTask_Cnt_M_u08)
	{
		return;
	}
 ...
 * Outputs:     None
 ****************************************************************************/
FUNC(void, AUTOMATIC) Metrics_CalcStackUse( void )
{
	uint16 i;
